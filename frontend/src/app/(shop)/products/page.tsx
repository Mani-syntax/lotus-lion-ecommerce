  ...
  return (
    <div className="min-h-screen bg-white py-10 text-[#1c1c1c]">
      <div className="mx-auto max-w-[1440px] px-5 sm:px-8">
        ...
        <div className="mb-8 hidden flex-col justify-between gap-4 border-y border-[#dddddd] py-4 md:flex md:flex-row md:items-center">
        ...
        {loading ? (
          <div className="grid grid-cols-2 gap-x-10 gap-y-14 md:grid-cols-4 md:gap-x-6 md:gap-y-8">
            {[...Array(8)].map((_, i) => (
          ...
          <div className="grid grid-cols-2 gap-x-10 gap-y-14 md:grid-cols-4 md:gap-x-6 md:gap-y-10">
